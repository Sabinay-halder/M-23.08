...
public class ShowcaseView extends RelativeLayout
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (showcaseDrawer.getBlockedPoints() == null || showcaseDrawer.getBlockedPoints().length == 0) {
            ...
            blocked = blockTouches && distanceFromFocus > showcaseDrawer.getBlockedRadius();
        } else {
            Rect rect = new Rect((int) showcaseDrawer.getBlockedPoints()[0], (int) showcaseDrawer.getBlockedPoints()[2], (int) showcaseDrawer.getBlockedPoints()[1], (int) showcaseDrawer.getBlockedPoints()[3]);//use your points co-ordinates
            float a[] = showcaseDrawer.getBlockedPoints();
    ...
    public static class Builder {
        ...
        public Builder withNewStyleShowcase(View view) {
            return setShowcaseDrawer(new NewRectShowCaseDrawer(activity.getResources(), activity.getTheme(), view));
        }
