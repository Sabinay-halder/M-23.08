 ...
 */
package com.widevision.pregnantwoman.kankan.wheel.widget.adapters;
 ...
 */
public abstract class AbstractWheelYearTextAdapter extends AbstractWheelAdapter {
     ...
     */
    protected AbstractWheelYearTextAdapter(Context context) {
     ...
     */
    protected AbstractWheelYearTextAdapter(Context context, int itemResource) {
