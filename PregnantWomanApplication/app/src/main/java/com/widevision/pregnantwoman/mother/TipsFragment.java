...
public class TipsFragment extends Fragment {
    ...
    /* private String category[] = {"Test Chart", "Health Tips", "Diet Tips", "Exercise Tips"};
 */
    /* 1.Test Chart
 2.Health Tips
 3.Diet Tips
 4.Exercise Tips*/
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mWebView.loadUrl("file:///android_asset/HTML_MOTHER/Diet-Chart.html");
        tipsEt.setText("Diet-Chart");
        try {
    ...
    public void setPicker(final List<String> strArr) {
        ...
        doneButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mWebView.loadUrl("file:///android_asset/HTML_MOTHER/" + category + ".html");
            }
        });
